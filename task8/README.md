...
Перед удалением скрипт проверяет, что рабочий каталог является Git-репозиторием,
что вычисленный путь находится внутри него и что файл `keep.txt` остаётся на месте.
